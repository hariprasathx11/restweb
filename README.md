...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="food1">
                <img src="foodieimage.jpeg"alt="pic">
                <b>FOODIE -$20</b>
            </div>
            <div class="food2">
                <img src="friedpotatoimage.jpeg" alt="pic">
                <b>FRIED POTATO-$15</b>
            </div>
            <div class="food3">
                <img src="oreoiceimage.jpeg" alt="pic">
                <b>OREO ICECREAM-$50</b>
            </div>
            <div class="food4">
                <img src="RamenNoodles.jpeg" alt="pic">
                <b>RAMEN NOODLES-$60</b>
            </div>
            <div class="food5">
                <img src="sandvegimage.jpeg" alt="pic">
                <b>SAND VEG-$30</b>
            </div>
            <div class="food6">
                <img src="SpringRolls.jpeg" alt="pic">
                <b>SPRING ROLLS-$40</b>
            </div>
            <div class="food7">
                <img src="cheeseimage.jpeg" alt="pic">
                <b>CHEESE PIZZA-$30</b>
            </div>
            <div class="food8">
                <img src="chocalateimage.jpeg" alt="pic">
                <b>CHOCALATE CAKE-$40</b>
            </div>
            <div class="food9">
                <img src="chickenfry.jpeg" alt="pic">
                <b>CHICKEN FRY-$50</b>
            </div>
            <div class="food10">
                <img src="eggbriyani.jpeg" alt="pic">
                <b>EGG BRIYANI-$40</b>
            </div>
        </div>
        <footer>
...
<html>
    ...
    <body>
        ...
        <div class="admin">
            <div class="a1">
                <img src="vivekimage.jpeg">
                <b>VIVEK</b>
                <b>CEO</b>
            </div>
            <div class="a2">
                <img src="babuimage.jpeg">
                <b>YOGI BABU</b>
                <b>Manager</b>
            </div>
            <div class="a3">
                <img src="santhanamimage.jpeg">
                <b>SANTHANAM</b>
                <b>Service Manager</b>
            </div>
            <div class="a4">
                <img src="senthilimage.jpeg">
                <b>SENTHIL</b>
                <b>Reception</b>
            </div>
            <div class="a5">
                <img src="vadivelimage.jpeg">
                <b>VADIVELU</b>
                <b>Accounts Manager</b>
            </div>
            <div class="a6">
                <img src="vijayimage.jpeg">
                <b>VIJAY</b>
...
body{
    background-image:url("contactimage.jpeg");
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
    font-size: 20px;
